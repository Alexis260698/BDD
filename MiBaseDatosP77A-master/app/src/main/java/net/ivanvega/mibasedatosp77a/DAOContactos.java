...
public class DAOContactos {
    ...
    public Cursor BuscarPorNombre(String criterio, String Nombre){
    ...
    public void eliminar(String criterio, int id){
        _sqLiteDatabase.query(
                MiDB.TABLE_NAME_CONTACTOS,
                MiDB.COLUMNS_NAME_CONTACTO,
                "delete from TABLE_NAME_CONTACTOS where id="+id+";",
                new String[]{criterio},
                null,
                null,null);
    }
